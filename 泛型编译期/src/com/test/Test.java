...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        list.add(111);
        list.add(222);
        Class clazz3 = null;//获取ArrayList的字节码文件
        try {
            clazz3 = Class.forName("java.util.ArrayList");
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        }
        Method m = null;//获取add() 方法，Object.class 代表任意对象类型的数据
        try {
            m = clazz3.getMethod("add", Object.class);
